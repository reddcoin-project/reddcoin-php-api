...
namespace IndieBlock\Reddcoin\Tests\Responses;
...
class ReddcoindResponseTest extends TestCase
{
    /**
     * Set up test.
     *
    ...
    public function setUp()
    {
        ...
        $this->response = new ReddcoindResponse($this->guzzleResponse);
    ...
    {
        $response = new ReddcoindResponse($this->rawTransactionError());
    ...
    public function testSerialize()
    {
        ...
        $serialized = sprintf(
            'C:%u:"%s":%u:{%s}',
            strlen(ReddcoindResponse::class),
            ReddcoindResponse::class,
