...
use IndieBlock\Reddcoin\Traits\HandlesAsync;
...
class Client
{
    ...
    /**
     * Makes request to Reddcoin Core.
     *
     * @param string $method
     * @param mixed  $params
     *
    ...
    /**
     * Makes async request to Reddcoin Core.
     *
     * @param string        $method
     * @param mixed         $params
    ...
    {
        // use same var name as laravel-reddcoinrpc
    ...
    {
        return 'IndieBlock\\Reddcoin\\Responses\\ReddcoindResponse';
    }
